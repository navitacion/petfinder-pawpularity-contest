# Reference: https://www.kaggle.com/debarshichanda/pytorch-hybrid-swin-transformer-cnn
...
class PawpularityHybridModel(nn.Module):
    def __init__(self, backbone, embedder, img_size, out_dim, pretrained=True):
        super(PawpularityHybridModel, self).__init__()
